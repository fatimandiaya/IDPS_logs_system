...
ips =
{
    ...
    rules = [[
	include /usr/local/snort3/etc/rules/local.rules
    ]]
}
...
--RULE_PATH = '/usr/local/snort3/etc/rules'

alert_json = {
    file = true,
    fields = "timestamp msg proto src_addr src_port dst_addr dst_port action class priority rule"
